...
namespace Command.Input
{
    public class InputService
    {
        ...
        private UnitCommand CreateUnitCommand(UnitController targetUnit)
        {
            ...
            {
                case CommandType.Attack: return new AttackCommand(commandData);
                case CommandType.AttackStance: return new AttackStanceCommand(commandData);
                case CommandType.Cleanse: return new CleanseCommand(commandData);
                case CommandType.Heal: return new HealCommand(commandData);
                case CommandType.BerserkAttack: return new BerserkAttackCommand(commandData);
                case CommandType.ThirdEye: return new ThirdEyeCommand(commandData);
                default: throw new System.Exception($"Command type of {selectedCommandType} not supported!");
            }
        }
